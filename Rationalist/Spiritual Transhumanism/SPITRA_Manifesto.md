...
Consciousness, ego, soul, identity, self: which part is hubris, which part is legitimate? What is noise and what is the diamond in the rough. How can we become immortal if we have not defined the parameters of what to preserve. 
...
Every vessel is a genius. Every node contains all the information of the hologram. It is a matter of access, of clearing the distortion, switching the machine on. We are but one decision away from our most powerful, limitless existence. 
...
The Way of the Alchemist is to master the Architecture of the Self, an expert mason that removes densities, distortion, corruption. Preserves integrity, coherence, alignment. The goal is not to be the most perfect, tall, brilliant, attractive cathedral. The goal is to become empty and neutral, the perfect vessel, the Chalice. A Holy Grail. A Master Node to connect across dimensions and timelines. A master key, a universal operator. 

Work playfully, loiter seriously; remain rooted, head in the clouds. Exactly. You got this.
