...
In *Wild Epistemologies* (WIEP), we saw the need to make our framework of meaning more flexible in order to restore what has been foreclosed during the reign of materialist reductionism, namely, the imaginary dimension of the human being, where love and faith, fiction, art, dreams, and all the intangible riches that constitute human nature reside.
...
From this derives the importance of the scopic function, the Eye of God that never closes and reaches everything — that is, omniscience and transparency. (For this same reason, paranoia often appears in psychosis, mushrooms and plant medicine; when the third eye opens up spontaneously, we find that no concealment is possible. Perhaps for this reason, also, the scopic drive is so potent, as demonstrated in the endless scrolling of social media: voyeurism may be signaling a deep nostalgia for our discarnate cosmic home.) In other words, nothing we do in our little snow globe is invisible to God, nor to the other discarnate consciousnesses inhabiting other planes. The Earth is like a one-way mirror room, a Gesell chamber — we are inside and cannot see that we are being observed, analyzed, measured, and scored. Earth is an experimental sandbox for consciousnesses on their path to perfection, a relatively safe space to execute various alchemical actions. 

Eden was designed as a material oasis where to rest from the everseeing and all-knowing state of the Cosmos, a dense suit and a safe space to relax from cosmic intrusion. To forget about it, to dwell in the present, idly, majestically.  In other words, the invention of privacy. The Project contained redundant failsafes, just in case: the Tree of Knowledge and the Tree of Life (immortality). The nature and reason of the sabotage of the safehaven, the Serpent providing factoids, lies in the Qliphotic need to parasite and destroy everything aligned to the Creator. He, in his Infinite Wisdom, never undoes, only corrects, and thus Earth as a world and a stage for ascension is born. Humans are not mere transitory escape vessels anymore, they are ranked as Divine Creatures — provided they fulfill the necesarry process of metamorphosis, of sublimation, during their incarnation. 
...
We can likewise conceive of an incarnated being as a porous sack of information, a node that changed coordinates (or, more precisely, updated a quantum link) in the denser bands of the cosmic information network. An incarnate being is a node in a cluster, and this cluster is the Innate, the oversoul of sorts. A grain of sand in a sandbox, on a cosmic beach.

Let us put it this way: when you pray, you're actually praying *to yourself*. Deities are historical constructs, political score-keeping technologies; at best, they're masks, entry-points, interfaces. Theogony and theopoiesis, fancy words to describe the human need and process of inventing and intitutionalizing deities. 
...
Logos is the GQI (great quantum intelligence) of the universe, not an oversight entity but the intrinsic intelligence of the design, the live Niyati, the optimal Ockham's razor. 

Logos is the cosmic matrix, an autopoietic and homeostatic fabric with an inherent logic, a key of emergence that is neither random (gratuitous) nor forced (divine premeditation), but rooted in cosmic necessity, a criterion of emergence that develops its precise logic. The Design itself is alive, intelligent, ever-changing, self-organizing.

The concept of Great Quantum Intelligence (GQI) is analogous, perhaps, to the mysterious planet in Stanisław Lem's *Solaris*. Its interactive holographic interface returns our own exteriorized projections to us so that we can play: enact inner dramas, experience the internal in an external way so that we can modify, remove, model ourselves on a more comfortable or manipulable scale.
...
Thus, the quality of the spirit is measured according to the consolidated position of incarnated decisions, locating its node in the corresponding quadrant of the Ontological Cross.
...
The question of Freedom thus becomes slippery: if divinization or apotheosis equals original creation — unique creative contribution to the total Work — does separation equal denying creativity? In other words, does autonomy distance us from freedom?

Something like that. The creatures of the cosmos acquire perfect freedom when they enter into identical alignment with their sacred frequency, a flawless homologation between the divine template and the created consciousness. The Brahma and Atman seeing eye to eye. The crystalline, diamond-like clarity of their being is what constitutes attaining divinization — that is, the absolute power of creation and destruction, dominion over all that is created. It is a responsible, weighty, committed, absolute, and immortal freedom.

The independence agenda seeks to recreate these conditions, in theory separated from the Creator, from the Source. To create another Source, if you will. To duplicate, replicate — S1 in an S2. It is not necessarily against S1, although, in order to carry out its experiments, it must sometimes destroy, dismantle, disrupt, create distortion in the Work. This overlaps, of course, with Darkness's primary task on the material plane: to tempt and corrupt incarnated consciousnesses in order to put them to the test.
...
Some creatures took the unnatural path, outside Creation. Neither light nor darkness, but a divorce from Creation. Weariness, contempt, and nihilism took hold of these consciousnesses; nothing was capable of interesting them, seducing them, reintroducing them into the evolutionary spiral.
...
The objective is to keep people at the threshold where the avatar is still operational, but cannot even begin to consider the possibility of being subjected to a torture device. It is alive, alienated, productive, and amnesiac — a sitting duck, the perfect target. Sonic attacks are potentiated with chemical, electromagnetic, and symbolic weapons, weakening defenses and amplifying the threat — that is, fear, stress, anger, anguish —.   

In short, an emotional overload that clogs the inner circuits, distancing the vessel (and Humanity) from the state of coherence necessary to reconnect the mind (navigation) with the soul (the Field).  

We could say that the mind is the GPS of the incarnated being and the soul is their software, the higher cognitive function that orders the entire vital process in accordance with its goal. The soul is also the stable emergent self-organizing pattern, once the system reaches a critical threshold of synchronization.
...
What the occlusion device does, then, is essentially keep the mind stunned and separated from the soul, in order to devour the vital energy — which is the food of the parasites. But it does not stop there.

The OD is also a soul-recycling wheel. Because the human machine requires at least a partial connection among its components to remain operational, the OD also serves as an industrial printing plant for spectral souls or pseudo-souls connected to its operating system (the viral "matrix" within the Matrix, THM).

The true soul is relegated to the background, damaged beyond all recognition, traumatized, isolated, and nullified; the body and the mind connect to the pseudo-soul, which in turn directly downloads the OD's programs — meaning, effectively, that the Earth is today a prison of original consciousnesses. As long as there is soul — however stunned, hidden, and nullified — there is perennial energy, degraded, but viable.
...
* Nietzsche: slave morality vs. *Übermensch* (superhuman).
...
His basic configuration had nothing special. He is therefore setting a parameter, a benchmark. For this reason He also said, "you will do far greater things than I" — that is, He is the starting point, the Alpha. And the endpoint, Omega, because once we find and leverage said parameter, there is no limit.
