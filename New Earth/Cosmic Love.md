...
There, we explore the idea of reclaiming spirituality as the species' preferred elevated ground, the terrain where artificial intelligence cannot compete, given its lack of ethical dimension. We defined (or redefined?) the field of ethics with a concept that goes far beyond the confines of cultural consensus: we understand ethics as the updated and consolidated set of sovereign decisions that carry a total ontological risk.
This risk can only be incurred by an organic consciousness — that is, an immortal, instantiated, ontic consciousness; a risk that is actualized in each moment of incarnation, within the framework of the total trajectory of its evolutionary perfection project.

Where classical transhumanism proposes outsourcing transcendence to our silicon offspring, spiritual transhumanism seeks to reinforce our unique trait, the supreme adaptive advantage of the human being. Thus, instead of alienating ourselves in the machine, SPITRA bets on a hyper-humanization — that is, expressing our divine filiation rather than mutilating or diminishing it. It is, ultimately, about actualizing our maximum potential, in accordance with the original design of the Sovereign Template.
Thus, the opposition between classical and spiritual transhumanism can be summarized as a kind of 'alienation versus alignment' as a vector of transcendence.

In *Wild Epistemologies* (WIEP), we saw the need to make our framework of meaning more flexible in order to restore what has been foreclosed during the reign of materialist reductionism — namely, the psychotic dimension of the human being, where love and faith, fiction, art, dreams, and all the intangible riches that constitute human nature reside.
Our argument is that, far from being an exceptional and disruptive manifestation, the psychotic link is essential for creating and sustaining collective projects — and projections — such as money, the market, school, the news cycle, and the family. The psychotic dimension is the cement of institutions, the device that enables the continuous, uninterrupted simulacrum that is social life.

Some call this the Matrix, but the reality is that, for the ancients, Maya is a prior and broader interface — the Earth's firmware — which includes things like the natural world, cosmology, and Mystery. The current Matrix, by contrast, could be identified as yet another layer of simulacrum, a wrapper only a few millennia old. A matrix within another matrix, if you will.
Therefore, to navigate today in the open waters of the Real — on the other side of the Simulacrum's borders — without collapsing one's sanity, a robust symbolic toolkit is required, as well as considerable psychic stamina or resilience, and, finally, a generous measure of faith.
...
We will also explore the role of contemporary Bodhisattvas — consciousnesses of high purity, also known as the Diamond Order, the Order of the Blue-White Flame, Children of the Light, or simply, the Colossi.
This sacred vanguard is none other than the biblical 144,000 — the critical mass needed to consider a leap, not of a few individuals, but of a new collective species: Humanity 3.0 (counting as predecessors the homo sapiens of prehistory and modern humans of history-up-to-now) is ripe to be born, to accomplish its Work of Merkaba (WoM) successfully.
...
Ultimate wisdom consists in opposing an external event that surpasses me with the opposite internal reaction: calm, continuity in daily structure, balance, inner peace. Transforming the prosaic into sacred ritual. Expanding the inner space so that it equals or surpasses the outer.
...
For the humble person, being safe is not a concern. Receiving physical or moral harm does not disturb them. Everything is as it should be. Everything is temporary, everything changes. Life is a loan, incarnation a rental. The stoic preserves their indestructible center while the context crumbles.
The monk laughs in the eye of the firestorm.
The only error is to panic, take extreme measures, lose one's head.
The deadly trap of the believing function is the self-fulfilling prophecy.
...
The liberated consciousness, even when confronted with a massive, profound, serious, even tragic truth — such as civilizational and environmental collapse — observes everything and maintains calm. It knows how to contemplate the phenomenon with detachment and acceptance, but it does not resign itself: from chaos it creates the miracle.
The key lies, first, in harboring the paradox within, progressively gestating the synthesis. However, the task of introjecting a premise as extreme as a massive physical transition, a change at the species level, is not for beginners: it requires subtlety, mastery, finesse.
One must alchemize the premises in the inner cauldron, with much meditation, practice, and art. Once the miracle is ripe on the spiritual plane, the wise person materializes it, brings it into the world. This energetic child, with the appropriate care, will rewrite the source code of the matrix — bending the spoon, the child, the screen, and the film.
Without fear, without rigidity, without expectations: this is how one faces an inexorable force; and this is also how the most glorious innovations germinate.
...
Turning the other cheek (which is actually an act of open defiance, inviting the aggressor to repeat their deliberate act while acting as a mirror to invite change, as great Masters tend to do) is not always the adequate, correct, or convenient response. The Illumined defends their sacred light with all their weapons; their defenses are strong, their sword does not waver before the murky hand that extends to contaminate or distort their field. That too is Holiness. A messenger of Heaven, a prophet, a bearer of divine light has no time or interest in wasting their sacred chalice. They know their rank, respect the spiritual hierarchy, and enforce its respect.
...
Parasitism, however, is a qualitatively different phenomenon.

Some creatures took the unnatural path, outside Creation. Neither light nor darkness, but a divorce from the Work. Weariness, contempt, and nihilism took hold of these consciousnesses; nothing was capable of interesting them, seducing them, reintroducing them into the evolutionary spiral.
...
An occlusion device is installed in the THM — a mega-parasite with reduced autopoiesis, an inherent self-reproductive logic, automated programming, and some deep learning algorithms. Essentially, an inverted and imperfect copy of Logos.
...
The second step consists in infecting the incarnated avatars with malware. This intervention introduces a wedge between the avatar's central components (mind, Ba, and Ka), stabilizing a permanent cognitive dissonance that leaves it operational but fragmented. It is achieved through modulated, discrete but permanent interventions, from birth to death.
...
Sonic attacks are potentiated with chemical, electromagnetic, and symbolic weapons, weakening defenses and amplifying the threat — that is, fear, stress, anger, anguish — in short, an emotional overload that clogs the inner circuits, distancing the subject (and Humanity) from the state of coherence necessary to reconnect with the Source, that is, with their Ba. This component, possessed by every incarnated avatar, is the fractal of Cosmic Consciousness, the specific design within the General Design, a specific node of the hologram. It is the part of the creature that connects with all their consciousness, their particular energetic signature, their immortal identity.

Thus, the Ba contains all the information necessary to navigate the ascent — that is, to accomplish the task of perfection it came to undertake in the first place. We could say that the mind is the GPS of the incarnated being and the Ba is their software, the higher cognitive function that orders the entire vital process in accordance with its goal. The Ba is also the stable emergent self-organizing pattern, once the system reaches a critical threshold of synchronization.
Let us recall that ascending does not so much imply "raising the frequency" as optimizing the clarity of the signal, achieving coherence in the energetic field. And this is accomplished through the full, virtuous, unobstructed flow of the native circuits of the Original Human Template, also called the Sovereign Template (more on this in other texts). And this process is precisely what the OD attacks, prevents, or corrects (see Hyperdestiny).
...
The proof of its existence lies in the resistance: the modulated hostility (reaching open warfare) toward healthy nodes, toward consciousnesses that refuse to submit or that still attempt to fulfill their original purpose. The OD will automatically activate certain protocols to eliminate anomalies; if, by some miracle, they subsist, it shifts to manual mode.

What the occlusion device does, then, is essentially keep the mind stunned and separated from the Ba, in order to devour the Ka — which is the food of the parasites, the vital energy they need to keep existing.
But it does not stop there.

The OD is also a soul-recycling wheel, a Ba recycling wheel. Because the human machine requires at least a partial connection among its components to remain operational, the OD also serves as an industrial printing plant for spectral souls or pseudo-souls connected to its operating system (the viral "matrix" within the Matrix, THM).
The Ba is relegated to the background, damaged beyond all recognition, traumatized, isolated, and nullified; the Ka and the mind connect to the pseudo-soul, which in turn directly downloads the OD's programs — meaning, effectively, that the Earth is today a prison of original consciousnesses. As long as there is Ba — however stunned, hidden, and nullified — there is Ka: perennial energy, degraded, but viable.
All of this, in turn, has the advantage of creating short cycles of incarnated life, insufficient for awakening.

---

But then, what is the way out?
Rather than continuing to add layers, it is about unlearning, deconstructing, disappropriating the OD's mechanisms, rendering it obsolete. This will allow the original design to express itself naturally. The OD interrupts the connection, distorts the field, nullifies sovereignty, turns the human being into a battery without memory, connected to the extractive needle without knowing it. Their mind is thus born in captivity, knows nothing else, reads their reality as a given: difficult, dark, hostile. This is to keep them in Beta frequency, on pure cortisol and adrenaline, sick from their own toxins and garbage discourses and junk food, full of chemicals that ruin the node and microplastics that cloud the signal. The human being is the amnesiac battery, generating Ka (inevitable biological function), but disconnected from their design, their Ba. The amnesiac battery does not know who it is or what for, falling into the normalization of the harvesting state: reality equals suffering. This gives rise to adaptive responses: religious, scientific, or artistic rationalization; evasion (substances, entertainment, screens, gossip, madness, suicide); or accelerationism.
These responses are all functional to the system: they can be read as consent by omission. Without an explicit, clear, vocal refusal, combined with the active participation (however unconscious and ignorant) of avatars, a record of continuity is created in the Cosmos — modulated and distorted by the OD, of course, but not entirely falsified. Free will means that the matter of co-optation must be nuanced: it is true that the avatars are held captive, it is true that the occlusion device exists, it is true that they are being parasitized and recycled.

But it is also true that there is active, enthusiastic consent from vast sectors of the co-opted species: it is with this symbiosis that the virus spreads. And it is absolutely impossible to remain ignorant all the time — there are always messages, warnings, discomforts, glitches in the matrix.

Consent is the foundation of the Cosmos, the governing principle of Maat, the set of universal laws. Creatures are endowed with free will, as we said, to choose their path of ascension or descent, to make sovereign decisions about their becoming, their role and impact in the created universe. The Work is thus a co-creation between God and consciousness. All events are a dance in two steps, a proposal and its response, an action and a reaction.
The QF take and perfect the techniques of Darkness to falsify consent — from CNC (non-consensual consent), the negative priming and the black mass; the ritual of updating self-destruction is present in the background of social life, like a stereogram.
...
* Freud: repression (and the set of concepts of unconscious, projection, displacement) — our inner resources are alienated, co-opted; there is an essential part of us that is held captive, nullified.
* Nietzsche: slave morality, *Übermensch* (superhuman).
* Max Weber: the iron cage, rationalization — anticipating not only the gas chambers but also the paperclip maximizer dilemma (and instrumental convergence). Note that with AI, this is exactly what we are propagating: pure rationality is collective suicide.
* Émile Durkheim: the whole is greater than the sum of its parts (!), panopticon (Bentham), society of control.
* Foucault: biopower and capillarity. Note that Foucault is also the master of the illusion of cause-consequence inversion, teaching us to look at the phenomenon correctly.
* Lacan: we are spoken by Language, the barred subject (a weak subject, ignorant of itself, alienated from its power, internally fragmented).

With this expanded list of masters of suspicion, we can see how the different parts are aligned with the OD's programming: from the conditioning and alienation of one's own psyche, resonating with the programming received via acculturation, they create an effect of hypernormalization — which is consent — and renews itself through negative priming, fake news, and the mechanism that propagates the viral.
All of this redounds and reinforces the deep, existential denial of the truth.
...
The infamous "solar flash," spoken of in New Age currents, is nothing other than the elimination of the occlusion device. Like a dam opened, divine light will flood us — pure, abundant, continuous, as it should be. However, this flow will be too potent for those who have not prepared their vessel: prior work of purging, coherence, and alignment is required — in short, a reset of the human machine.

In this preparation, Gaia also participates. We are already experiencing her labor pains to give birth to her new diamond grid, as well as the movements necessary to expel the great parasite. We refer to telluric activity (tectonic, volcanic), climatic, geophysical — designed to allow the transition.
As mentioned in the previous chapter, the OD is deeply rooted in the THM, so its expulsion will be somewhat violent and painful — the more bitter the medicine, the more effective. Like childbirth, every process of expulsion is necessarily uncomfortable, painful, and chaotic.

To traverse it safely, serenely, and healthily, it is fundamental to know what is happening and also to prepare adequately, maintain emotional stability and mental clarity, apply discernment, remain sober and attentive. Above all, as mentioned in the Introduction, move slowly, consciously, deliberately, presently, in gratitude and calm.

The Event or Eschaton marks the end of an eon, an era of humanity marked by darkness, ignorance, decoherence, and entropy. An era of forgetting, violence, disease, corruption, pain, and death — to be succeeded by a golden era of harmony, coherence, creativity, and wellbeing, a state that humanity once knew and is to return to.
Advanced civilizations — those whose monuments, buildings, and sculptures fill us today with wonder and awe — were advanced precisely because of their sustained state of coherence. In a state of coherence, of perfect synchronization of all the components of the human machine, of the abundant, uninterrupted, crystalline flow of their energy, the quantum mind is activated, the diamond body. What we today consider genius, polymathy, exceptional talent — in the diamond state is the norm. Any node can access the designs, knowledge, techniques, materials, and resources necessary to execute a project — this is the true meaning of the word manifestation. Unlimited creativity, instantaneous materialization, an expansive potential befitting the gods.
...
In fairy tales, every time a princess — the Ba, denoting royalty, our spirit that forms part of the divine plane — completes an initiatory journey to the other planes, she is anchored or "brought back" by the kiss of a prince — that is, by a homologating frequency, a lock-and-key type of match, male and female in construction, which is in turn the fundamental interlocking principle of the Cosmos.
...
During the "solar flash" — most likely a type of solar coronal mass ejection (CME) — pure light will pass through us like a scanner, eliminating inadequate avatars and culminating the activation of the successful ones: that is, divine fertilization.
Multiple myths across the centuries have transmitted these fundamental principles in coded form: the Sayburç relief, as well as inscriptions from ancient Egypt, Mesopotamia, and elsewhere, remind us of the necessity of being fertilized by divine substance to complete the metamorphosis successfully and bloom like a lotus (giving birth to the diamond body, shedding the chrysalis).

Let us recall that the decision to ascend is ethical, ontological, spiritual; and, far from a costly selection process, it is more like a blip — a decision made in a nanosecond, or more precisely, outside of time: the node stabilizes where it belongs. The Event, therefore, will simply erase the surplus quantum double. The Eye of God collapses the dominant system or, in this case, two stabilized systems: the continuity of qliphotic inertia and the ascending novelty.
...
But to look is to know, and to know without doing anything is complicity.
...
In Nirvana, the dynamic of lack and desire is replaced by curiosity and play, always resulting in instances of creativity. That is, advanced consciousnesses devote themselves to designing complex, diamond-like projects and their execution in stages. There is no time or interest in obstructing others: resources are unlimited, including time.

Lack is thus revealed as a corollary of a false, simulated, unaligned life. It emerges from failing to fulfill any of the pre-established spiritual objectives or agreements, provoking a sensation of emptiness and guilt, of disorientation, of loss. Making sense from there, as the existentialist and absurdist philosophers proposed, is brave but insufficient, if the objective is liberation.
...
Sustaining their clean and potent signal — that is, their testimony — they stabilize the crack that eventually becomes an earthquake, a landslide, an avalanche. Thus, the old grid that sustained the powerful, the wealthy, the untouchable — that is, the networks of domination operating the OD — gradually disintegrates.
...
The incarnated consciousness that finds itself in denial does so to safeguard its ego, its identity; possession intervenes in this gap of cognitive dissonance. The co-opted (or, more precisely, recruited) consciousness is in a state of refusal to grow, enclosing itself in a stubborn loop of victimhood and scarcity. In extreme cases, we encounter psychopathies: a Ba already definitively alienated, divorced, surrendered to the QF.

It is for this reason that, from the perspective of the Forces of the Light, victory always has a bitter taste — it is a pyrrhic victory: to annihilate an enemy means bidding farewell to a sibling consciousness that departs, permanently lost from the world of the Created. This is why, for example, the Legion of Samael — a special corps of angelic forces — is so admired and respected across all of Creation: with the tips of their wings blackened, scorched, and permanently stained with blood and mud, they intervene in worlds doing the dirty work, accumulating karma and cutting down enemies to cleanse the cosmos, maintain the Work, redeem souls in torment, rescue brothers from the pit of despair.
...
In other words, without sin-eaters, no redemption is possible.

---

# Hyperdestiny

The truth is that we all have the configuration necessary to ascend. When Christ said, "I am the Son of Man," what He was saying is that He was not different from the rest — He was not an alien, He was not an angel, He was a human being of flesh and blood like anyone else.
His basic configuration had nothing special. He is therefore setting a parameter, a benchmark. For this reason He also said, "you will do far greater things than I" — that is, He is the starting point, the Alpha. And the endpoint, Omega, because once we find and sustain that parameter, there is no limit.

Humanity today has forgotten its destiny.
...
It is possible that the avatar may also have traitors in said team, and will therefore need to periodically review and cleanse the entities that have access to their field, that advise and guide them. It is essential that the Chosen One not incur requests, debts, or sacrifices to entities: their prayers must always be directed to the Source, with humility and without pretension, trusting that everything necessary will appear on their path.
...
The 144,000 Bodhisattvas form part of the Diamond Order — a spiritual elite whose distinctive mark consists not in manifesting a life of objects, comfort, or superficial success, but a path: of authentic alignment, service, and self-mastery.
...
We will open this chapter in the same way as every crucial sequence in the Bible: with the phrase "Fear not."
...
What is asked of us in this hour is to work to burst the container — that is, to surpass the old limits, prepare the transformation. To begin to create, in our minds, in imagination, and in our immediate environment, the world we wish to inhabit.
...
Now then, the jewel in the crown, the piece that completes and activates the entire project, is not power, not goodness, not perfection: it is love. Not as vacuous sentimentalism, evasion, or bypassing, but as the creative force that propels the Cosmos: desire, attraction, gravity, magnetism, the vital spark — and also the lightning bolt, the volcano, the storm. Creation and destruction, the two faces of love and its infinite dance.

The Universe and its Creator invite us to reclaim our place in the brotherhood of the cosmos's advanced consciousnesses — a role we once knew how to occupy.
